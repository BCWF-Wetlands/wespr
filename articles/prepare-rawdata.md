...
can be used to import a stanadard set of spatial dataset required for
the Desktop Analysis. A vingette which details this process can be found
[`vignette("prepare_spatial_data")`](https://bcwf-wetlands.github.io/wespr/articles/prepare_spatial_data.md).
...
The next step in this process is to calculate wespr scores. See
