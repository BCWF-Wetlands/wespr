...
Users can also generate a summary report per site. This requires similar inputs as used to assign_jenks_score, however users also need to define file path location where the report will be saved as a .word document. 
In this example we use a folder called "temp"
