...
If the ecoprovince does not yet have calibration data loaded, users should select the next best ecoprovince available. Ecoprovinces not yet calibrated inlcude: Central Interior (CI), Northern Boreal Mountains (NBM), and Coast and Mountains (CM)
...
```
Calibrated Ecoprovinces (as of April 2026) include the following: Georgia Depression (GD), Southern Interior (SI), Southern Interior Mountains (SIM), Sub-Boreal Interior (SBI), and Boreal and Taiga Plains (BTP).
