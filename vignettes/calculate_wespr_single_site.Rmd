...
Users can also generate a summary report per site. This requires similar inputs as used for the `r assign_jenks_score()`. Users also need to define an output directory where the output file will be saved. In this example below, we use a folder called "temp"
