...
field <- system.file("extdata/field_survey123_edited.xls", package = "wespr")
...
write.csv(ww, fs::path("input_data/wetFlat_20250325.csv"), row.names=FALSE)
...
```{r, eval=FALSE}
indata <- system.file("input_data/wetFlat_20250325.csv", package = "wespr")
