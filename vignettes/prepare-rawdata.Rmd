...
As of November 2025, data collection is comprised of three parts:

- field data - collected using survey123 form
- office desktop questions - collected using a survey123 form
- office GIS related questions - scripted using the [WESP_OF](https://github.com/BCWF-Wetlands/WESP_OF) github repo. Note these can also be processed manually using QGIS or equivalent software and can be input into a survey123 form.  
